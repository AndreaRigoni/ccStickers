#ifndef MPLSEQUENCECOMBINER_H
#define MPLSEQUENCECOMBINER_H
...
struct next< ccs::mpl::combine_iterator<Seq, Pos> > {
    typedef typename ccs::mpl::SequenceCombiner<Seq,Pos>::next next_Pos;
    typedef ccs::mpl::combine_iterator< Seq, next_Pos > type;
};
